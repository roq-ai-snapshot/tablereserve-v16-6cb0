...
export const HelpBox: React.FC = () => {
  ...
  const applicationName = 'TableReserve v16';
...
4. As a Waiter, I want to view and update table availability, so that I can efficiently manage reservations and walk-ins.

5. As a Waiter, I want to create and manage customer profiles, so that I can store their preferences and provide personalized service.

6. As a Waiter, I want to create, update, and cancel table reservations, so that I can manage bookings and optimize restaurant occupancy.

7. As a Customer, I want to search for restaurants, so that I can find a suitable place to dine.

8. As a Customer, I want to create a profile, so that I can store my preferences and make reservations more efficiently.

9. As a Customer, I want to view available tables and make a reservation, so that I can secure a table at my preferred restaurant.

10. As a Customer, I want to update or cancel my reservation, so that I can make changes to my plans as needed.`;
